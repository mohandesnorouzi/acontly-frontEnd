...
const appRoutes: Routes = [
  ...
  {
    path: 'overview', canActivate: [AuthGuard], component: OverviewComponent, children: [
      {path: 'content', component: OverviewContentComponent},
      {path: 'analysis', component: OverviewAnalysisComponent}
    ]
  },
